...
namespace PizzaApp.Helper
{
    public static class Data
    {
        ...
        {
            new Review("Super Pici", Customers[0].Id)
        };
        ...
        public static IEnumerable<SelectListItem> CustomersToSelectListItems()
        {
            return Customers.Select(c => new SelectListItem($"{c.FirstName} {c.LastName}",c.Id.ToString()));
        }
